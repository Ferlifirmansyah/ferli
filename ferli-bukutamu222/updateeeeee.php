...
include "boot.php";
$id = $_GET['id'];
$tampil = $koneksi->query("select * from bukutamu_ferli where no='$id'");
...
<div class="container mt-2">
  ...
  if (isset($_POST['update'])) {
    $update = $koneksi->query("update bukutamu_ferli set tanggal='$_POST[tanggal]',nama='$_POST[nama]',jk='$_POST[jk]',alamat='$_POST[alamat]',umur='$_POST[umur]',keperluan='$_POST[keperluan]'where no='$id'");
