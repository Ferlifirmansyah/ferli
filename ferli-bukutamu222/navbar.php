...
include "boot.php"
?>
<body style="background-image: url(444.jpg);
...
<nav class="navbar navbar-expand-lg bg-info-subtle">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      ...
      <li class="nav-item">
          <a class="nav-link active" aria-current="page"h="#"><h5>BUKU TAMU RUMAH SEHAT</h2 >
        </li>
        <li class="nav-item">
...
<ul class="list-group mt-2" >
  ...
  <a href="logout.php" target="">
       <label  onclick="return confirm('ANDA INGIN KELUAR')"><font style="color:black;"> <b>LOGOUT</b></font></label></a> 
  </li>
</ul>
</div>
  <!-- tutup side  -->
  ...
  <div class="col col- mt-2">
      <iframe src="beranda.php" frameborder="0" name="konten" width="100%" height="600"></iframe>
